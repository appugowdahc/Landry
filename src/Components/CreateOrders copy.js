              ...
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell><button  type="submit" className="btn3" id="0" onClick={(e)=>{calculate(e)}}>{expression[0]}</button></TableCell>
                    <TableCell >
                  ...
                  <TableRow>
                    ...
                    <TableCell><button type="submit" className="btn3" id="1" onClick={(e)=>{calculate(e)}}>{expression[1]}</button></TableCell>
                    <TableCell >
                  ...
                  <TableRow>
                    ...
                    <TableCell><button type="submit" className="btn3" id="2" onClick={(e)=>{calculate(e)}}>{expression[2]}</button></TableCell>
                    <TableCell >
                  ...
                  <TableRow>
                    ...
                    <TableCell><button type="submit" className="btn3" id="3" onClick={(e)=>{calculate(e)}}>{expression[3]}</button></TableCell>
                    <TableCell >
                  ...
                  <TableRow>
                    ...
                    <TableCell><button type="submit" className="btn3" id="4" onClick={(e)=>{calculate(e)}}>{expression[4]}</button></TableCell>
                    <TableCell >
